  ...
  return (
    <Svg
      ...
      <Path
        ...
        stroke={theme.colors.textColor}
      />
      <Path d="M12 11V15" stroke={theme.colors.textColor} />
      <Path d="M15 3L13 6" stroke={theme.colors.textColor} />
      <Path d="M9 3L11 6" stroke={theme.colors.textColor} />
      <Path d="M7 16H2" stroke={theme.colors.textColor} />
      <Path d="M22 16H17" stroke={theme.colors.textColor} />
      <Path
